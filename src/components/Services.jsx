...
const TagCard = ({ number, title, text, className, aosDelay, aosType, pathLength, containerRef }) => {
  ...
  return (
    <div 
      ...
      isActive
      ? 'bg-gradient-to-br from-[#1A1A1A] via-[#500014] to-[#800020] border border-[#800020] shadow-[0_20px_50px_rgba(128,0,32,0.35)]'
    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex justify-center mb-8">
          <span id="resume" className="inline-block border border-gray-300 rounded-full px-5 py-1.5 text-sm text-gray-600 font-bold shadow-sm bg-white">
            FEATURED PROJECTS
          </span>
        </div>
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <div className="flex gap-4">
            ...
            <a href="/JNE RESUME 2026.pdf" target="_blank" rel="noopener noreferrer"
               className="px-6 py-3 border border-[#800020] text-[#800020] font-semibold rounded-full hover:bg-[#800020] hover:text-white transition-all">
              View Resume
            </a>

            <a href="/JNE RESUME 2026.pdf" download  className="px-6 py-3 bg-[#800020] text-white font-semibold rounded-full hover:bg-[#990026] transition-all" >
              Download Resume
            </a>
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            From full-stack travel platforms to modern frontend applications, these projects highlight my skills in React, Node.js, MongoDB, Tailwind CSS, and building real-world user experiences.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard
            number="01"
            title="WanderLiving"
            text="A full-stack travel and accommodation booking platform built using the MERN stack, featuring user authentication, property listings, and responsive design.
            MERN Stack | MongoDB | Express | React | Node"
            github=""
            className="md:absolute md:top-[150px] md:right-[10%] rotate-2 md:rotate-6"
            aosType="fade-left"
            aosDelay="100"
          ...
          <TagCard
            number="02"
            title="Spotify Clone"
            text="A responsive music streaming interface inspired by Spotify, featuring playlists, navigation, interactive UI components, and modern frontend design.
            HTML | CSS | JAVASCRIPT"
            github=""
            className="md:absolute md:top-[700px] md:left-[10%] -rotate-2 md:-rotate-6"
            aosType="fade-right"
            aosDelay="200"
            pathLength={pathLength}
            containerRef={containerRef}
