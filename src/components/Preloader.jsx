    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#0D0D0D] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-red-900/30">
              MuskanCreates<span className="text-red-900/30">.</span>
            </div>
            ...
            >
              MuskanCreates<span className="text-maroon">.</span>
            </motion.div>
          </motion.div>
